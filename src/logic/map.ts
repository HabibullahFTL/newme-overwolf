...
import {
  getDimensions,
  getTileCoordinatesForWorldCoordinate,
  getTileLevel,
  getTileScale,
} from "./tiles";
...
function getTilesInternal(
  ...
  const centerTilePos = getTileCoordinatesForWorldCoordinate(
    worldPos,
    tileScale
  );
